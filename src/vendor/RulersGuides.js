    ...
    var doc         = document.documentElement,
        ...
        OpenGridDialog = function () {
            ...
            this.render = function () {
                if (dialog === null) {
                    ...
                    document.getElementById('J-playground').appendChild(dialog);
        ...
        Menu = function () {
            ...
            this.render = function () {
                ...
                document.getElementById('J-playground').appendChild(menuBtn);
                document.getElementById('J-playground').appendChild(menuList);
        ...
        prepare     = function () {
            ...
            setTimeout(function () {
                ...
                document.getElementById('J-playground').appendChild(wrapper);
